...
public class ParagraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ParagraphActivity.this, ParagraphDetailedActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (index != -1) {
                Log.d("test", "onActivityResult Index: "+ index);
                students.set(index, student);
                Log.d("test", "onActivityResult: "+ student.paragraphTestScore.toString());
